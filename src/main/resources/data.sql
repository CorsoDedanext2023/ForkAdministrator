...
INSERT INTO technician (is_available, max_workload, workload, role, name, surname, username, password)
VALUES (TRUE, 5, 0, 3, 'Edwar', 'Azzaro', 'hacker', '123456ee!');

INSERT INTO technician (is_available, max_workload, workload, role, name, surname, username, password)
VALUES (TRUE, 5, 0, 3, 'Luigi', 'Cannizzaro', 'LCanniz', '6789aaa_!');

INSERT INTO technician (is_available, max_workload, workload, role, name, surname, username, password)
VALUES (TRUE, 5, 0, 3, 'Marco', 'Neri', 'mNeri', '0012abc_?');
